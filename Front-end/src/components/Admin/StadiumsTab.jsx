...
import { faEllipsisVertical, faXmark, faUser } from '@fortawesome/free-solid-svg-icons';
...
const StadiumsTab = ({currentTab}) => {
    ...
    return (
        <div className={(currentTab === 2 ? '' : 'hidden')}>
            <StadiumForm isOpen={formOpen} handleClose={() => setFormOpen(false)} callbackFunction={refreshStadiumsList}/>
