    ...
    <div className="toolbar_container">
      ...
      <ul className="toolbar_tabs">
        ...
        {isSignedIn ? (
          <Fragment>
            <li>
              <Link to="/reserved_matches">Reserved Matches</Link>
            </li>
            <li>
              <div className="user-box-wrap" onClick={toggleDropdownList}>
                <div className="user-icon">
                  <FontAwesomeIcon icon={faCircleUser} size="2xl" />
                </div>
                <div
                  className={'user-drop-down-list '.concat(
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <div className="description">Settings & Privacy</div>
                    </li>
                    <li>
                      <div className="icon">
                        <FontAwesomeIcon icon={faFileContract} />
                      </div>
                      <div className="description">Terms of Agreement</div>
                    </li>
                  </ul>
